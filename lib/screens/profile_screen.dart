  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.logout,color: Colors.white,), // Add a logout icon here
            onPressed: () {
        ...
        child: Column(
          ...
          children: [
            ...
            if (onEditProfile != null)
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: CustomTheme.loginGradientStart, // Custom button color
                ),
            ...
            ElevatedButton(
              ...
              child: const Text('Group Chat',style: TextStyle(color: Colors.white),),
            ),
            ...
            ElevatedButton(
              ...
              child: const Text('View Upload History',style: TextStyle(color: Colors.white),),
            ),
          ],
        ),
      ),
